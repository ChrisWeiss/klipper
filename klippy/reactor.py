...
class SelectReactor:
    ...
    def _check_latency(self, eventtime, timeout):
        prev_eventtime = self._recent_eventtime
        self._recent_eventtime = eventtime
        if timeout or eventtime - prev_eventtime < self._latency_warning:
            # High latency not detected - prep for next pass
            if timeout:
    ...
    def _dispatch_loop(self):
        ...
        while self._process:
            ...
            busy = self._check_latency(eventtime, timeout)
